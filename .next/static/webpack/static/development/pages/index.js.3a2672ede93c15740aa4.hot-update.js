...
/* harmony import */ var konva__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! konva */ "./node_modules/konva/lib/index.js");
...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_7__["default"])(Home, [{
    ...
    key: "test",
    value: function test() {
      var stage = new konva__WEBPACK_IMPORTED_MODULE_20___default.a.Stage({
        container: 'testcanvas',
        width: 500,
        height: 750
      });
      var layer = new konva__WEBPACK_IMPORTED_MODULE_20___default.a.Layer();
      var layer2 = new konva__WEBPACK_IMPORTED_MODULE_20___default.a.Layer();
      var layer3 = new konva__WEBPACK_IMPORTED_MODULE_20___default.a.Layer();
      var layer4 = new konva__WEBPACK_IMPORTED_MODULE_20___default.a.Layer();
      var text = new konva__WEBPACK_IMPORTED_MODULE_20___default.a.Text({
        text: 'Perritu',
        fontSize: 20,
        width: 500,
        align: 'center',
      ...
      var text2 = new konva__WEBPACK_IMPORTED_MODULE_20___default.a.Text({
        text: 'Aaaaaaaaa',
        fontSize: 15,
        width: 500,
        align: 'center',
      ...
      var text3 = new konva__WEBPACK_IMPORTED_MODULE_20___default.a.Text({
        text: 'uwu',
        fontSize: 10,
        y: 250,
        x: 60
      });
      var text4 = new konva__WEBPACK_IMPORTED_MODULE_20___default.a.Text({
        text: 'uwu',
        fontSize: 10,
        y: 450,
        x: 90
      ...
      var label = new konva__WEBPACK_IMPORTED_MODULE_20___default.a.Label({
        x: 100,
        y: 100,
        draggable: true
      }); // add a tag to the label

      label.add(new konva__WEBPACK_IMPORTED_MODULE_20___default.a.Tag()); // add text to the label

      label.add(new konva__WEBPACK_IMPORTED_MODULE_20___default.a.Text({
        text: 'Hello World!',
        fontSize: 20,
        lineHeight: 1.2,
        padding: 10,
    ...
    value: function render() {
      ...
      return Object(_emotion_core__WEBPACK_IMPORTED_MODULE_14__["jsx"])("div", {
        ...
        __self: this
      })), Object(_emotion_core__WEBPACK_IMPORTED_MODULE_14__["jsx"])("div", {
        id: "testcanvas",
        __source: {
          fileName: _jsxFileName,
          lineNumber: 480
        ...
        __self: this
      }), Object(_emotion_core__WEBPACK_IMPORTED_MODULE_14__["jsx"])("button", {
        onClick: this.test,
        __source: {
          fileName: _jsxFileName,
          lineNumber: 481
...
//# sourceMappingURL=index.js.3a2672ede93c15740aa4.hot-update.js.map